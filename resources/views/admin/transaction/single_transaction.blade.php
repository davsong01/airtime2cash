                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        @php
                                                            ...
                                                            $airtime2Cash = $transaction->airtime2cash;
                                                            $bankTransferResponse = is_array($airtime2Cash?->bank_transfer_api_response ?? null)
                                                            ...
                                                            <div class="col-md-1">
                                                               ...
                                                               <div class="col-md-3">
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    @if($airtime2Cash?->payment_method === 'Transfer to Bank Account')
                                                                        <strong>Bank Transfer Status</strong> <br>
                                                                        <span><strong>{{ ucfirst(str_replace('_', ' ', $bankTransferStatus)) }}</strong></span><br><br>
                                                                    @endif
