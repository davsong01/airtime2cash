...
Route::get('cron/requery-pending-airtime2cash-transactions/{api?}/{pick?}', [TransactionController::class, 'requeryPendingAirtime2CashTransactions'])->name('cron.requery.pending.airtime2cash.transactions');
...
Route::middleware(['auth', 'verified', 'admin', 'ipcheck', 'adminRoute'])->prefix('admin')->group(function () {
    ...
    Route::get('single-airtime2cash-transaction-view/{transaction}/bank-transfer-requery', [TransactionController::class, 'requeryAirtimeBankTransfer'])->name('admin.requery.airtime2cash.bank.transfer');
